...
class Person:
    ...
    def __str__(self):
        __email = (self.__first_name + "." + self.__last_name + "@gmail.com").strip()
        return f"{self.__first_name} {self.__last_name} is {self.__age} years old and her email id is {__email}"
